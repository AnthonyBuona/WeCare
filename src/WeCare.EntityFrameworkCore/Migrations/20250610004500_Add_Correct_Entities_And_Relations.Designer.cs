...
namespace WeCare.Migrations
{
    ...
    [Migration("20250610004500_Add_Correct_Entities_And_Relations")]
    partial class Add_Correct_Entities_And_Relations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WeCare.Patients.Patient", b =>
                {
                    ...
                    b.Property<Guid>("PrincipalResponsibleId1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PrincipalResponsibleId1");
            ...
            modelBuilder.Entity("WeCare.Patients.Patient", b =>
                {
                    b.HasOne("WeCare.Responsibles.Responsible", null)
                        .WithMany("Patients")
                    ...
                    b.HasOne("WeCare.Responsibles.Responsible", "PrincipalResponsible")
                        .WithMany()
                        .HasForeignKey("PrincipalResponsibleId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
